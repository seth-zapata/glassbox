...
record	Record against the deployed Worker	2026-08-13T01:01:24.9823547Z [36;1mset +e[0m
record	Record against the deployed Worker	2026-08-13T01:01:24.9824239Z [36;1mnpm run eval:record[0m
record	Record against the deployed Worker	2026-08-13T01:01:24.9824797Z [36;1mcode=$?[0m
record	Record against the deployed Worker	2026-08-13T01:01:24.9825262Z [36;1mset -e[0m
record	Record against the deployed Worker	2026-08-13T01:01:24.9826125Z [36;1m# Exit 3 means the daily Workers AI allocation is gone. That is a budget condition,[0m
record	Record against the deployed Worker	2026-08-13T01:01:24.9827568Z [36;1m# not a quality signal, and failing the run for it would raise an alarm identical to a[0m
record	Record against the deployed Worker	2026-08-13T01:01:24.9828811Z [36;1m# real regression — which is how people learn to ignore the real one.[0m
record	Record against the deployed Worker	2026-08-13T01:01:24.9829688Z [36;1mif [ "$code" -eq 3 ]; then[0m
record	Record against the deployed Worker	2026-08-13T01:01:24.9830286Z [36;1m  echo "budget_exhausted=true" >> "$GITHUB_OUTPUT"[0m
record	Record against the deployed Worker	2026-08-13T01:01:24.9831767Z [36;1m  echo "::warning::Daily Workers AI allocation exhausted; recording skipped. Not a quality regression — the allocation r
record	Record against the deployed Worker	2026-08-13T01:01:24.9833378Z [36;1m  exit 0[0m
record	Record against the deployed Worker	2026-08-13T01:01:24.9833935Z [36;1mfi[0m
record	Record against the deployed Worker	2026-08-13T01:01:24.9834597Z [36;1mexit "$code"[0m
...
[36;1m{[0m
[36;1m  echo "### Tier 2 — live evaluation"[0m
[36;1m  echo ""[0m
```
