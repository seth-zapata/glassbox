...
source_url: https://developers.cloudflare.com/registrar/whoisrequests/
source_file: src/content/docs/registrar/whoisrequests.mdx
license: CC-BY-4.0
attribution: © Cloudflare, Inc. Cloudflare Docs, licensed under CC BY 4.0.
---

This page describes the mechanism and process for submitting a disclosure request to Cloudflare for WHOIS data under Section 10 of the Internet Corporation for Assigned Names and Number's ("ICANN") Registration Data Policy.
