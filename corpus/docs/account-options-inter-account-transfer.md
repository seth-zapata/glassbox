---
id: account-options-inter-account-transfer
title: "Move a Cloudflare Registrar domain registration between accounts"
source_url: https://developers.cloudflare.com/registrar/account-options/inter-account-transfer/
source_file: src/content/docs/registrar/account-options/inter-account-transfer.mdx
license: CC-BY-4.0
...
* Obtain the account ID of the new account.
* Add the domain as a website to the new account and select a plan.
* Disable DNSSEC for the domain and ensure it is set up and ready in the new dashboard account you intend to move it to.
